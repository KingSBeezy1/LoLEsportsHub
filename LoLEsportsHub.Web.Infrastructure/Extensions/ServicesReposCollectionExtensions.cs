...
using static LoLEsportsHub.GCommon.ExceptionMessages;

namespace LoLEsportsHub.Web.Infrastructure.Extensions
{
    public static class ServicesReposCollectionExtensions
    {
