    ...
    public partial class InitialDbCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserMatches", x => new { x.ApplicationUserId, x.MatchId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserMatches_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApplicationUserMatches_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateTable(
                name: "TournamentsMatches",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TournamentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MatchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ScheduledTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TournamentsMatches_Tournaments_TournamentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TournamentMatchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tickets_TournamentsMatches_TournamentMatchId",
                        column: x => x.TournamentMatchId,
                        principalTable: "TournamentsMatches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserMatches_MatchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_TournamentMatchId_UserId",
                table: "Tickets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tournaments_Name_Region",
                table: "Tournaments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TournamentsMatches_MatchId_TournamentId_ScheduledTime",
                table: "TournamentsMatches",
                columns: new[] { "MatchId", "TournamentId", "ScheduledTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TournamentsMatches_TournamentId",
                table: "TournamentsMatches",
                column: "TournamentId");
        }
