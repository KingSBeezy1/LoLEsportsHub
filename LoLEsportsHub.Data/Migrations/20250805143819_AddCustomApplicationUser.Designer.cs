...
namespace LoLEsportsHub.Data.Migrations
{
    ...
    [Migration("20250805143819_AddCustomApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LoLEsportsHub.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("LoLEsportsHub.Data.Models.ApplicationUserMatch", b =>
                {
                    b.HasOne("LoLEsportsHub.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("BookmarksMatches")
            ...
            modelBuilder.Entity("LoLEsportsHub.Data.Models.Organizer", b =>
                {
                    b.HasOne("LoLEsportsHub.Data.Models.ApplicationUser", "User")
                        .WithOne("Organizer")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LoLEsportsHub.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
